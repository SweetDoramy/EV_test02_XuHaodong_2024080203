...
#include "my_msg/msg/detail/a__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const my_msg::msg::A *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_msg::msg::A *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _A__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const my_msg::msg::A *>(
...
static size_t _A__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_A(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _A__callbacks = {
  "my_msg::msg",
  "A",
  _A__cdr_serialize,
  _A__cdr_deserialize,
...
static rosidl_message_type_support_t _A__handle = {
...
{
  return &my_msg::msg::typesupport_fastrtps_cpp::_A__handle;
}
