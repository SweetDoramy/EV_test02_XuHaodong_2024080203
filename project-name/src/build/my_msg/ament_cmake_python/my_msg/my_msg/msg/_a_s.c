...
bool my_msg__msg__a__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    char full_classname_dest[16];
    {
    ...
    assert(strncmp("my_msg.msg._a.A", full_classname_dest, 15) == 0);
  }
  my_msg__msg__A * ros_message = _ros_message;
  {  // image
...
{
  /* NOTE(esteve): Call constructor of A */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_msg.msg._a");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "A");
