...
: ${AMENT_CURRENT_PREFIX:="/home/dotamy/project-name/src/install/cpp_node_demo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp_node_demo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp_node_demo/environment/path.sh"
